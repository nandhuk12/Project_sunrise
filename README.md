...
Scope of the project is to create an intelligent keyboard to predict the next character in a word and next word in a sentence. The system should be able to auto-complete the word and the sentence meaningfully. It is based on the probability distribution. During the training word sequences are not observed. It is mostly based on the assumption that the probability of a word that depends on the previous “n” number of words.
